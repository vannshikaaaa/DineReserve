...
def train_cancel_model():
    ...
    print(f"Cancellations   : {y.sum()} ({y.mean()*100:.1f}%)")
    ...
    joblib.dump({"model": model, "features": features}, "ai/models/cancel_model.pkl")
    print("Saved: ai/models/cancel_model.pkl")
