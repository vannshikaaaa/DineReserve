        ...
        <div style={card}>
          ...
          <form onSubmit={submit}>
            <div style={field}>
              ...
              <FI type="email" placeholder="admin@restaurant.com" onChange={set("email")} required />
            </div>
            <div style={field}>
              <label style={label}>Password</label>
              <FI type="password" placeholder="••••••••" onChange={set("password")} required />
            </div>
            <div style={field}>
              ...
              <p style={{ fontSize: "12px", color: "#4a4844", marginTop: "6px" }}>
                The unique password set for your restaurant
              </p>
            </div>
            <button
          ...
          <div style={foot}>
            No admin account?{" "}
            <Link to="/admin-register" style={{ color: "#b89a6a", fontWeight: "500" }}>Register restaurant</Link>
          </div>
        </div>
      </div>
    </div>
