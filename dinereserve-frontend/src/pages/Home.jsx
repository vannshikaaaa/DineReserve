  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "18px 20px 20px" }}>
        <h3 style={{
          fontFamily: SERIF, fontSize: "19px", fontWeight: "400", color: T1,
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "4px", marginBottom: "16px" }}>
          {[
            ...
            { label: "Price",   val: r.price_range ?? "—" },
            { label: "Type",    val: r.restaurant_type ?? "—" },
          ].map(({ label, val }) => (
            <p key={label} style={{ fontSize: "13px", color: T2, margin: 0 }}>
              <span style={{ color: T3, marginRight: "8px", fontSize: "11px", letterSpacing: "0.06em", textTransform: "uppercase" }}>
                {label}
              </span>
              {val}
            </p>
        ...
        <div style={{
          padding: "10px 0 0", borderTop: `1px solid ${BORDER}`,
          fontSize: "12px", fontWeight: "500",
          color: hov ? GOLD : T3, letterSpacing: "0.08em", textTransform: "uppercase",
          transition: "color 0.2s", display: "flex", alignItems: "center", justifyContent: "space-between",
        }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <button
                onClick={applyFilters}
                style={{
                  padding: "10px", background: GOLD, color: "#0c0d0f",
                  border: "none", borderRadius: "8px",
              ...
              <button
                onClick={() => { setPref(""); setCuisine(""); setType(""); setBudget(""); setGuests(""); setSearch(""); fetchRestaurants(); }}
                style={{
                  padding: "10px", background: "transparent",
                  border: `1px solid ${BORDER_MD}`, borderRadius: "8px",
                  color: T3, fontFamily: "'Jost', sans-serif", fontSize: "13px",
                  cursor: "pointer", width: "100%", boxSizing: "border-box",
                }}
              >
                Clear
