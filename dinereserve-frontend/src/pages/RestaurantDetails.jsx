    ...
    <div style={{ minHeight: "100vh", background: BG, fontFamily: SANS, paddingBottom: "60px" }}>
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "40px 24px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "40px", alignItems: "start",
          background: S1, border: `1px solid ${BRD}`, borderRadius: "20px", padding: "32px", boxShadow: "0 8px 32px rgba(0,0,0,0.4)" }}>

          {/* Image */}
          <div>
            <img src={restaurant.image} alt={restaurant.name}
              style={{ width: "100%", height: "340px", objectFit: "cover", borderRadius: "14px", display: "block" }}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <h1 style={{ fontFamily: SERIF, fontSize: "32px", fontWeight: "400", color: T1, lineHeight: 1.1, letterSpacing: "-0.01em" }}>
              {restaurant.name}
            </h1>
            <p style={{ fontSize: "14px", color: T2, lineHeight: 1.7 }}>{restaurant.description}</p>

            <div style={{ display: "flex", flexDirection: "column", gap: "10px", padding: "16px 0", borderTop: `1px solid ${BRD}`, borderBottom: `1px solid ${BRD}` }}>
              {[
            ...
            <button onClick={() => navigate(`/restaurant/${id}/book`)}
              style={{ padding: "14px 28px", background: GOLD, color: "#0e0f0d", border: "none", borderRadius: "10px", fontFamily: SANS, fontSize: "15px", fontWeight: "600", cursor: "pointer", letterSpacing: "0.01em", transition: "all 0.2s", width: "fit-content" }}
